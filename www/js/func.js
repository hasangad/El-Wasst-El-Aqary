...
$(document).ready(function () {
	...
	// Loads 
	$('.splash').load("_splash.html");
	$UserInfoLoad = $('.USerInfo').load("_UserInfo.html");
	$('.main_menu').load("_Menu.html");
	$('.UserInfoContent').load("_UserCreateVacation.html");
	$('.UserInfoContent2').load("_UserCreatePermession.html");
